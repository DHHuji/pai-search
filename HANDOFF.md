...
python tests_search.py   # 354 טסטים — חיפוש, טקסט, מסמכים, UX, multi-value, chips, קיבוץ, CSV
```
...
ב-BUT המילה **היא** התג, ולכן קליק אחד מספיק — אין תת-תפריט ערכים, גם לפיצ'רים מסוג select. תוצאות חיפוש מקבלות קיצור `⚠ mark as BUT` בשורה נפרדת.
